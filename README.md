...
The second goal is to optimize malloc to perform extremely well for this specific application and create many tests with various access patterns. <br/>
